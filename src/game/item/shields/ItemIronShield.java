...
extends Item {
	...
	{
		if(inCam) screen.render(SpriteSheet.items.getSprite(32, 160, 16, 16), x, y, size, size, rot, alpha);
		else screen.renderGUI(SpriteSheet.items.getSprite(32, 160, 16, 16), x, y, size, size, rot, alpha);
	}
