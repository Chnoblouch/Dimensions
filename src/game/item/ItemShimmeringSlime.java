...
extends Item {
	...
	{
		if(inCam) screen.render(SpriteSheet.items.getSprite(0, 304, 16, 16), x, y, size, size, rot, alpha);
		else screen.renderGUI(SpriteSheet.items.getSprite(0, 304, 16, 16), x, y, size, size, rot, alpha);
	}
